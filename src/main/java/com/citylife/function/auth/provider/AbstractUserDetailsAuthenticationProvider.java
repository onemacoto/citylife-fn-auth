...
public abstract class AbstractUserDetailsAuthenticationProvider
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		Assert.isInstanceOf(Authentication.class, authentication,
		...
		if (user == null) {
			...
			try {
				user = retrieveUser(username, (Authentication) authentication);
		...
		try {
			...
			additionalAuthenticationChecks(user, (Authentication) authentication);
